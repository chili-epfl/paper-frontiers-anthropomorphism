...
time. The nature of the interaction (goal-directed, entertainment, etc.) may
however vary.
...
mind}~\cite{Premack1978a}). A theory of  mind for other agents enables us to
...
is already familiar with (ranging from animals to human adults, through
...
Anthropomorphism is traditionally empirically understood as the combination of
...
third factor that plays a key role. In this article, we propose a new formal
