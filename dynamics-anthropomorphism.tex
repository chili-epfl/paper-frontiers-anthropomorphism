...
anymore, the \emph{Stabilized Level of Anthropomorphism} is zero. This can either be interpreted as the user
considering the robot as merely a tool, or as a consequence of no interactions
taking place anymore with the robot (robot not used)\fxwarning{reference to the
roomba experiment}.
