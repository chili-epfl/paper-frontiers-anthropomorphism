...
and interaction, the human builds a model of the robot's behaviour that allows
...
ability to predict the behaviour of the robot: the initial apparent behavioural
...
\paragraph{Disruptive Behaviours}
