...
\footnote{This study is published in \cite{fink_living_2013}.} Hereafter, we refer to this study as the "Roomba study".

From the Roomba study, we can report on several findings related to anthropomorphism and the anthropomorphic design of robots. The gathered data for these aspects include qualitative observations, semi-structured interviews, and also quantitative assessments of various aspects of human-robot interaction. The Roomba study is one of very few long-term human-robot interaction studies in the domestic environment. 
...
Second, we present people's perception of human-likeness and social capabilities of the robot and how this perception changed over time.

\subsubsection{Anthropomorphic interactions with the robot}

It has been described in several previous studies of the Roomba \citep{forlizzi_service_2006,forlizzi_how_2007,krumm_my_2007,sung_domestic_2010}, that users tend to engage in a variety of non-cleaning activities associated with the Roomba including, but not limited to, naming, ascribing personality and gender. \cite{sung_housewives_2008} carried out a survey among 379 Roomba users to investigate how common these activities are. 

We also found that people tend to anthropomorphize or interact socially (in a broader sense) with their vacuum cleaning robot.
However, our long-term observations suggest that this effect is marginal, and that the social impact of a functional robot on a household seems to be generally overestimated.
In contrast to the previous work, we found that there were just few instances of people anthropomorphizing the robot and interacting with it in a human-social way. More importantly, overall, these anthropomorphic interactions with the robot did not last but seemed to be somehow related to the novelty of the robot.

In terms of how people interacted with the robot, we categorized several interactions and actions with the robot as anthropomorphic or social, in a broader sense. Examples of what we categorized as somehow social and anthropomorphic (human-like) interactions with the robot include \textit{watching} the robot for fun, giving a \textit{demo} of the robot to guests / visitors, taking a \textit{photo/video} of the robot, \textit{personalizing} the robot, giving a \textit{name} to the robot, \textit{talking} to the robot using direct speech, \textit{playing} with the robot, and making \textit{adjustments} to the home due to the robot. Figure \ref{fig:roomba-activities}) shows how many of the 9 households engaged in what kind of activity with the robot at three different points of time after the robot was deployed in the household.

\paragraph*{Watching the robot for fun.} We categorize watching a robot for fun as an entertaining, social activity, reflecting a feeling of empathy for the robot. In \cite{sung_housewives_2008} survey, 73~\% of the participants reported to watch their Roomba running for fun. While in the beginning of our study, also a quite high proportion (6 of 9 households) reported to watch the robot for fun, after 2 and 6 months the number of households that engaged in this activity decreased by half. 

\paragraph*{Giving a robot demo to visitors.} \cite{sung_domestic_2010} described that a vacuum cleaning robot can serve as a mediator and encourage social interaction among people. We categorize giving a demo of the robot to visitors / guest to the household as such an activity. During the first 2 weeks with the robot 8 of 9 households in our study showed their robot to others, and still after 2 and 6 months 5 of the households engaged in this activity. This number is more or less in accordance with the 57~\% of survey respondents who stated to give demonstrations to others \citep{sung_housewives_2008}.
...
In accordance with \cite{sung_housewives_2008} we also found relatively low rates of users treating and perceiveing their vacuum cleaning robot as a living (or human-like) entity. We interpret that it might be the pure functional purpose and non human-like form of the Roomba vacuum cleaning robot that prevented people from anthropomorphizing it. Still, we observed some initial anthropomorphic effects, such as collaborative cleaning with the robot, and talking to the robot.
