...
results. We studied anthropomorphism effects in several short- and long-term
...
\begin{figure}[h!]
        ...
        \end{subfigure}
    \caption{Usage and perception of the Roomba robot over a 6 months period.}
    \label{fig:roomba}
\end{figure}
...
no impact on his/her life (and the level of activity pictured on
...
comes from a (yet unpublished) study where 13 pairs of children (4-5 years old)
played for about 20 minutes a Domino game with a robot (the robot was tasked to
...
and the robot (like talking or showing objects), based on video annotations. On
...
\begin{figure}[h!]
        ...
        \begin{subfigure}[t]{0.48\columnwidth}
                \centering
                \includegraphics[width=0.6\textwidth]{ranger}
                \caption{The \emph{Ranger} Domino study}
                \label{fig:ranger-expe}
        \end{subfigure}%
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc.
          %(or a blank line to force the subfigure onto a new line)
        \begin{subfigure}[t]{0.48\columnwidth}
            \includegraphics[width=0.9\textwidth]{ranger-interactions-vs-qualitative-score}
            \caption{Qualitative level of anthropomorphic projections versus
            actual interactions with the robot}
            \label{fig:qualitative-score}
        \end{subfigure}
        \caption{Level of interaction with a semi-anthropomorphic robot is
        \emph{not} a predictor of anthropomorphic projections.}
    \label{fig:ranger}
\end{figure}
...
or to respond to social cues, such as facial expressions, social gestures or turn-taking. Also \cite{takayama_perspectives_2012} states that humans have a propensity toward particular cues that seem to trigger automatic interpersonal social responses. 
...
human, the robot is likely to be treated similar to a human (\eg eye-contact is 
...
Literature on anthropomorphism is quite diverse. There exist different understandings of what anthropomorphism is. 
...
facilitate or hinder anthropomorphism.
...
The neuroscientific study of human-robot interaction is still in its infancy. So far most studies have used robots as a way to investigate humans behavior and brain responses to perception of an artefactual agent actions and emotional states but have not really tapped in the study of how a human behaviors and brain processes are influenced by its direct interaction with a robot (add ref, ref). 
We briefly review below the neuroscientific literature relevant to understand the neural basis of anthropomorphism. 
...
Resonance behaviors \citep{Rizzolatti1999} are mechanisms by which the brain areas involved in the internal representations of an action, an emotion or a sensation are equally recruited during the perception of another individual performing the same action or experiencing the same emotion or sensation.  

\paragraph{Anthropomorphic response to motor behavior \\}
Resonance behaviors have first been shown in the motor mirror neurons system, that is a neural network in motor areas that fire both during the execution of specific goal-oriented action and during the viewing of action directed toward the same goal~\cite{Rizzolatti1996, Kilner2009}.

There are good evidence showing that the human brain responds to both human and robotic motion by activating motor mirror neurons \citet{Gazzola2007, oberman_eeg_2007}, stressing that the perceiving the goal of an action is more important than the human-likeness of its kinematic to activate resonance mechanisms.
...
\paragraph{Anthropomorphism and social behavior}
In studying emotional perception in a human or a robot face using functional magnetic resonance imagery (fMRI) \citet{Chaminade2010} found reduced activity in response to the robot stimuli than to the human stimuli in emotional brain areas known to have mirror properties. However if the subject was asked to specifically attend to the emotional content of the stimuli, processing the robot facial expression, but not the human's, elicited a significant increase in the anterior part of the anterior frontal gyrus, a brain area considered as a marker of motor resonance.

However, using electroencephalography another study have found that perception of emotions in a non-humanoid robot face affects the early brain processes of emotional expressions and the behavioral response of the participants the same way as did a human face \citep{Dubal2010}.
...
Finally, individual tendency to anthropomorphize has been related to the grey matter volume of a brain area involved in mentalizing - the attribution of mental states to other human beings \citet{cullen2013individual, Frith2003}. 

Thus it seems that the display of resonance mechanisms for social behavior in a human-robot interaction is less straightforward than for motor behavior and may dependent more on the internal attitude and cognitive conceptions the human has of the robot. 
...
Anthropomorphism at this pre-cognitive stage might also be mediated by the motor and emotional resonance mechanisms at the neuronal level. 
...
anthropomorphism} (section~\ref{sec:ica}). At this stage the human might also change his attitude towards the robot, paying more attention to social cue than to low-level behavior which may reinforce the resonance mechanisms. 
...
cognitive model of the robot. It is also at this last stage that the human might modified its own abilities to anthropomorphize, having built a full cognitive model of the robot and know being able to attribute internal state to the robot.
