...
match the affordances that our to humans adapted world brings along. Also, up to a 
certain point, anthropomorphic form as it increases anthropomorphism,
appears to be generally beneficial for human-robot relations, especially with socially 
interactive robots \cite{fong_survey_2003}. Consequently, the domain of (social) 
robotics tries to exploit this fact by enhancing anthropomorphism through 
anthropomorphic robots: Applying anthropomorphism or zoomorphism changes the 
way how users try to understand and make sense of a system by projecting everyday 
\hl{expectations} of human and animalistic life onto it. \cite{schmitz_concepts_2011}. 
