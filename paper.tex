...
As human-likeness itself is a huge dimension\fxwarning{SL: huge dimension?},
...
\begin{figure}
    ...
    phenomenon. Person- and artifact-related ones, but also related to the
context of use as well as the actual time spend interacting with the robot.}
...
\fxwarning{SL: maybe add a ref to previous Julia's paper on anthropomorphism?}
...
\footnote{\hl{Ha! This says that anthropomorphism can also occur on a behavioral
level, yes! :) so we should also measure anthropomorphism in the behavior.}}
...
anthropomorphism over time, \ie the general dynamics of anthropomorphism.\fixme{Last sentence: Do you mean the shape of the curve? i would not agree that it remains the same ... but say that it shows a general tendency to decrease, however that there might be variations.}
