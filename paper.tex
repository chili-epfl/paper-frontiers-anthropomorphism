...
Not only \cite{epley_when_2008} and \cite{duffy_anthropomorphism_2002} but also others have noticed that anthropomorphism is a very complex phenomenon -- itself and in how it can be understood. This raises question how to study and operationalize anthropomorphism in an appropriate way (see Section \ref{sec:measuring}}.
