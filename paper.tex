...
\begin{figure}[h!]
        ...
        \begin{subfigure}[t]{0.48\columnwidth}
                ...
                \caption{The \emph{Ranger} Dominos experiment}
...
\paragraph{Anthropomorphism and social behaviour}
In studying emotional perception in a human or a robot face using functional magnetic resonnance imagery (fMRI) \citet{Chaminade2010} found reduced activity in response to the robot stimuli than to the human stimuli in emotional brain areas known to have mirror properties. However if the subject was asked to specifically attend to the emotional content of the stimuli, processing the robot facial expresion, but not the human's, elicited a significant increase in the anterior part of the anterior frontal gyrus, a brain area considered as a marker of motor resonnance.

Howver, using electroencephalograpy another study have found that perception of emotions in a non-humanoid robot face affects the early brain processes of emotional expressions and the behavioral response of the participants the same way as did a human face \citep{Dubal2010}.
...
Thus it seems that the display of resonance mechanisms for social behaviour in a human-robot interaction is less straightforward than for motor behaviour and may dependent more on the internal attitude and cognitive conceptions the human has of the robot. 
...
Anthropomorphism at this pre-cognitive stage might also be mediated by the motor and emotional resonnance mechanisms at the neuronal level. 
...
anthropomorphism} (section~\ref{sec:ica}). At this stage the huma might also change his attitude towards the robot, paying more attention to social cue than to low-level behaviour which may reinforce the resonnance mechanisms. 
