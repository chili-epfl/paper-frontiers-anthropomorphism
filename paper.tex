...
\paragraph{Attractiveness Delta}

Besides, we propose to call \emph{attractiveness delta}, noted $\Delta_{a}$, the
difference between the initial capital of anthropomorphism \ICA for a given tuple (user,
robot, context) and the anthropomorphism peak \AntMax (Figure~\ref{fig:dynamics}).
This can be interpreted as the initial \emph{excitement} over the robot, or how
much a user tend to increase his/her anthropomorphic engagement when he/she
starts to actually interact with the robot.
