...
\section{Anthropomorphism as a multi-factor phenomenon ...}
...
\section{... that evolves over time}
...
Measuring anthropomorphism is challenging because the phenomenon is partialy
...
explored both Likert-scale and open questions.
...
\begin{figure}
    ...
    \caption{Quantitative assessment: here, six interactions modalities have
        ...
        occurences of each of these interactions.  Highlighted runs 2.3, 2.4,
        2.7 and 2.8 correspond to unexpected robot behaviours: we observe peaks
        of interactions everytime the robot's behaviour changes from expected to
