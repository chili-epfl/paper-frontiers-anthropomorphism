...
\newcommand{\ICAe}{{$\mathcal{A}^{e}_0$~}}
\newcommand{\SLA}{{$\mathcal{A}_\infty$~}}
\newcommand{\SLAe}{{$\mathcal{A}^{e}_\infty$~}}
\newcommand{\sla}{{\mathcal{A}_\infty}}
...
\draw (-0.05, 2.1) -- (0.05, 2.1) node[anchor=east] {\ICAe};
...
\draw (-0.3,2) node[anchor=east] {Stage 1}
      (-0.3,4) node[anchor=east] {Stage 2}
      (-0.3,6) node[anchor=east] {Stage 3};
...
\draw (-0.3,1.5) node[anchor=east] {Stage 1}
      (-0.3,3) node[anchor=east] {Stage 2}
      (-0.3,4.5) node[anchor=east] {Stage 3};
