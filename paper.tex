...
The essence of anthropomorphism is the perception of human-like characteristics in either real or imagined non-human agents. In human-robot interaction (HRI), anthropomorphism is a commonly observed phenomenon: people tend to ascribe human-like characteristics to robots, and they are willing to treat and react to robots as if they were human-social counterparts. The HRI and social robotics literature is full of various kinds of studies showing how humans readily interact in a social fashion with robots -- despite the fact that robots are not humans. In our own work on human-robot interaction analysis, we also observed anthropomorphism. However, we found qualitative differences and dynamics in how participants anthropomorphized and socially related to the robots used in our studies, which were mostly conducted in natural settings with normal people. More concretely, we found that anthropomorphism was not only based on how much the robot resembles a human (anthropomorphic design) but that it was determined by multiple factors, including the individual characteristics of the human user, and the context of use. We also found that anthropomorphism changed over time with growing experience of the user with the system. By trying to understand these variances and dynamics in anthropomorphism, we reviewed related work from the HRI domain and social robotics. Despite the fact that there is a vast amount of literature on anthropomorphism in HRI, we did not come across findings that were similar to ours and described how anthropomorphism would evolve over time. Instead, we found ourselves confronted with diverse and partially contradictory understandings of anthropomorphism. We also had the impression that the reported data were sometimes over-interpreted or obtained in settings and in a way that we believe do not give enough consideration to the complex nature of anthropomorphism.\footnote{As anthropomorphism emerges from an interaction between a human and a non-human agent, we believe that showing pictures of different kinds of robots and then using questionnaires to measure anthropomorphism is somehow limited. In the discussion section \ref{sec:discussion} we discuss what tools and measurements could be used to study anthropomorphism and its dynamics in interaction studies in real-world environments.} However, we found support for the observed variances and dynamics in anthropomorphism in literature from social psychology, cognitive science, and neuroscience. As these domains are also relevant in for HRI, we believe it is valid to use theories from these domains for interpreting our results and to report this.

In this article, we would like to share our somehow critical but constructive considerations on anthropomorphism in robotics. Thereby, we contribute to a refined understanding of this complex phenomenon related to interactions between humans and robots. In accordance with theories from other domains, we propose that anthropomorphism is determined and affected by multiple factors. Based on this multi-factor understanding, and the findings from our work, we suggest an initial model that we call "dynamics of anthropomorphism" that serves to describe how anthropomorphism evolves over time. We then present a cognitive and neuroscience perspective on anthropomorphism to consolidate this model. Finally, we discuss alternative ways how anthropomorphism in HRI can be studied and measured, as this is an important questions. 
...
Anthropomorphism is an interesting social phenomenon because it tells us something about the relation between the human who anthropomorphizes, and the non-human agent that is anthropomorphized. Though commonly observed, it appears controversial at the same time that humans tend to perceive human-like physical appearance (\eg faces), emotional states, or inner mental states and motivations in non-human agents\footnote{According to \cite{epley_when_2008}, a non-human agent can be anything that acts -- or is believed to act -- with apparent independence.}, such as animals, natural forces, religious agents, technological gadgets, or mechanical devices \citep{epley_when_2008}.  

Anthropomorphism and related questions such as "how much human do we perceive in the non-human" or "how human-like do we treat and interact with non-human artifacts" (and why?) have received remarkable attention across several domains.\footnote{Especially in human-pet relations and human-machine relations, anthropomorphism is frequently studied.}

In this section we will first clarify the terminology used. We present anthropomorphism as a social phenomenon and propose to use another term, namely anthropomorphic form, to refer to the human-inspired design of artifacts.
...
How a person relates to an agent further determines how she perceives and in turn behaves towards the agent, or how she may behave in light of this agent \cite{epley_when_2008}. 
