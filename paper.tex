...
emotional etc.) \fixme{addref}. Seeing a robotic arm reaching for an object
...
anthropomorphism over time, \ie the general dynamics of anthropomorphism.\fixme{JF: Last sentence: Do you mean the shape of the curve? I would not agree that it remains the same ... but say that it shows a general tendency to decrease, however that there might be variations, mostly determined by the 4 factors.}
